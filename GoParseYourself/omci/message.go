...
// Message defines the Baseline (not extended) protocol. Extended will be added once
...
func (omci *Message) String() string {
	return fmt.Sprintf("Payload")
}

// LayerType returns LayerTypeOMCI
func (omci *Message) LayerType() gopacket.LayerType {
	return LayerTypeOMCIBaselineMessage
}

func (omci *Message) CanDecode() gopacket.LayerClass {
	return LayerTypeOMCIBaselineMessage
}

// NextLayerType returns the layer type contained by this DecodingLayer.
func (omci *Message) NextLayerType() gopacket.LayerType {
	return LayerTypeOMCITrailer
}

func decodeOMCIBaselineMessage(data []byte, p gopacket.PacketBuilder) error {
	omci := &Message{}
	return omci.DecodeFromBytes(data, p) // TODO: Where is our exposed access function ?
}

func (omci *Message) DecodeFromBytes(data []byte, p gopacket.PacketBuilder) error {

	//decoder, err := MsgTypeToStructDecoder(0)
...
func (omci *Message) SerializeTo(b gopacket.SerializeBuffer, opts gopacket.SerializeOptions) error {
